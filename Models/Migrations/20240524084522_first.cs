        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JjMmYyyy = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DateTables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Utilisateurs_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Utilisateurs_DateTables_DateTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_DateTables_DateTableId",
                        column: x => x.DateTableId,
                        principalTable: "DateTables",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commentaires_DateTableId",
                table: "Commentaires",
                column: "DateTableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Utilisateurs_AppUserId",
                table: "Utilisateurs",
                column: "AppUserId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Utilisateurs_DateTableId",
                table: "Utilisateurs",
                column: "DateTableId");
        }
